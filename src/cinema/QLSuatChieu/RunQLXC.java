...
public class RunQLXC {
    ...
    JLabel lblTitle,lblClose,lblMaPhim,lblNguoiTao,lblMaPhong,lblBatDau,lblKetThuc,lblNgayChieu;
    JTextField txtMaXC,txtMaPhim,txtNguoiTao,txtMaPhong,txtBatDau,txtKetThuc,txtNgayChieu;
...
//        CBOJpanel.setOpaque(true);
        ...
        //mainJTab.set
            ...
            XCJPanel.setName("Xuat Chieu");
                ...
                TextJPanel.setBackground(Color.yellow);
                    ...
                    txtMaPhim.setPreferredSize(new Dimension(cw+20, ch-15));
                    txtMaPhim.setEditable(false);
                    TextJPanel.add(txtMaPhim);
                    
                    lblMaPhong = new JLabel("Ma Phong",JLabel.LEFT);
                    lblMaPhong.setPreferredSize(new Dimension(cw/2+10, ch-15));                    
                    ...
                    txtMaPhong.setPreferredSize(new Dimension(cw+20, ch-15));
                    txtMaPhong.setEditable(false);
                    TextJPanel.add(txtMaPhong);
                    
                    lblNguoiTao = new JLabel("Nguoi Tao",JLabel.LEFT);
                    lblNguoiTao.setPreferredSize(new Dimension(cw/2+10, ch-15));                    
                    ...
                    txtNguoiTao.setPreferredSize(new Dimension(cw+20, ch-15));
                ...
                Text1JPanel.setBackground(Color.BLUE);
            ...
            String[] col = {"Maphim","NguoiTao","MaPhong","BatDau","KetThuc","NgayChieu"};            
    ...
    void fillTable(){
        ...
        try {
            ...
            List<SuatChieu> list = dao.selectByMaPhimMaPhong_SQL(phg.getMaPhong());
            for(SuatChieu sc : list){
                Object[] row = {
                  sc.getMaPhim(),
                          sc.getNguoiTao(),                  
