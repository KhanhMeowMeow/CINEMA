...
public class RunQLThongKe {
    ...
    private void myGUI(){
        ...
        mainJFrame.setLayout(null);
            ...
            lblTitle = new JLabel("Quan ly Xua.");
            ...
            mainJTab.setBackground(new Color(255, 240, 235));
                ...
                HotJPanel.setName("HotPhim");
                    ...
                    cboHot = new JComboBox();
                    cboHot.setFont(new Font("Arial",1,20));
                    cboHot.setPreferredSize(new Dimension(cw*4-50, ch));
                    //cboSapXep.setBackground(Color.blue);
                    cboHot.addItem("Xem Nhiều Nhất");
                    cboHot.addItem("Xem Ít Nhất");
                    cboHot.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
                    cboHot.setBorder(BorderFactory.createLineBorder(Color.black, 10));
                    HotJPanel.add(cboHot);
